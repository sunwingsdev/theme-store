...
import TextAreaInputForCard from "./TextAreaInputforCard";

const ControlTextAreaCard = ({ name, page, category }) => {
...
export default ControlTextAreaCard;
